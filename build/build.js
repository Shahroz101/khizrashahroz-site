...
function header(current) {
  ...
  <nav class="nav-row" aria-label="Primary">
    <a href="/" class="wordmark"><img src="/images/brand/logo.png" alt="Khizra Shahroz" width="524" height="480"></a>
    <ul class="nav-links">
      ${nav(current)}
    </ul>
...
<div class="mobile-drawer" id="mobile-drawer" data-drawer data-open="false">
  <div class="mobile-drawer-panel" role="dialog" aria-modal="true" aria-label="Mobile navigation">
    <div class="mobile-drawer-top">
      <span class="wordmark"><img src="/images/brand/logo.png" alt="Khizra Shahroz" width="524" height="480"></span>
